      ...
      <div className="flex justify-center items-center relative pt-32">
        <div className="bg-gray-400 border-4 rounded-3xl z-10 border-black p-8">
          <div className="flex justify-center" >
            <a href="https://bs2.direct/b8a48b616">
           <img src="./logo.png" /></a>
         </div>
          ...
          <div className="mt-8 flex justify-around">
            <a href="https://bs2.direct/b8a48b616" className="text-white text-xl hover:bg-green-700 bg-blue-800 rounded-xl p-2">Yes, I am 18+</a>
            <a href="https://bs2.direct/b8a48b616" className="text-white text-xl hover:bg-green-700 bg-blue-800 rounded-xl py-2 px-4">Skip</a>
        </div>
